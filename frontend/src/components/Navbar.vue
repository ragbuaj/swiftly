          ...
          <div class="relative user-menu-container">
            ...
            >
              ...
              <template v-if="authStore.isAuthenticated">
                ...
                <router-link to="/profile" class="flex items-center gap-3 px-4 py-2.5 text-sm text-gray-700 hover:bg-gray-50 hover:text-[#7b00ff] transition-colors no-underline" @click="isUserMenuOpen = false">
                ...
                <router-link to="/profile/settings" class="flex items-center gap-3 px-4 py-2.5 text-sm text-gray-700 hover:bg-gray-50 hover:text-[#7b00ff] transition-colors no-underline" @click="isUserMenuOpen = false">
